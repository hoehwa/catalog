...
Such issues arise when entire objects are passed as dependencies when you only need a primitive value. Due to the nature of objects, [being pass-by-reference](https://github.com/mindulle/Documents/blob/main/js/s/pass-by-reference-or-pass-by-value/README.md), comparing the dependencies will always trigger a re-run. This ends up causing effects to run unnecessarily.
