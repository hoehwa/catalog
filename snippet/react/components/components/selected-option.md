...
For a more detailed explanation of the component, as well as usage examples, you can check out the [Select component](https://github.com/mindulle/Documents/blob/main/react/s/select/README.md).
