...
This is pretty much how the [copyToClipboardAsync snippet](https://github.com/mindulle/Documents/blob/main/js/s/copy-to-clipboard-async/README.md) is implemented and should work across all modern browsers.
...
There are a couple of other considerations, such as restoring the user's previous selection on the document, which can be easily handled with modern JavaScript. You can find the final code with these improvements implemented in the [copyToClipboard snippet](https://github.com/mindulle/Documents/blob/main/js/s/copy-to-clipboard/README.md).
