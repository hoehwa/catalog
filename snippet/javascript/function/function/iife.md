...
Note that you can also use arrow functions for IIFEs, if you like. Just make sure to remember the differences between regular and arrow functions in that case. Our previous articles on [arrow functions](https://github.com/mindulle/Documents/blob/main/blog/s/javascript-arrow-functions/README.md) and [the `this` keyword](https://github.com/mindulle/Documents/blob/main/blog/s/javascript-this/README.md) should just about cover them.
