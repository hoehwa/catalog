...
If you want to read more about the `this` keyword, you should check out our [previous article on the subject](https://github.com/mindulle/Documents/blob/main/blog/s/javascript-this/README.md).
