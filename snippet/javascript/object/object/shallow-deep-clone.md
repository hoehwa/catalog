...
Alternatively, you can use a recursive function that deep clones an object and is a lot faster, such as the one in the [deepClone snippet](https://github.com/mindulle/Documents/blob/main/js/s/deep-clone/README.md). Similarly, if you want a ready-to-use shallow cloning function, you can find one in the [shallowClone snippet](https://github.com/mindulle/Documents/blob/main/js/s/shallow-clone/README.md).
