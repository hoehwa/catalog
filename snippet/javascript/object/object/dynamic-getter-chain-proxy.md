# Chaining dynamic getters using the Proxy object
...
Looking at the use case at hand, I thought that I could stitch together a general-purpose solution using JavaScript's `Proxy` object. In fact, I think that the concept of dynamic getters and setters that I described in [my previous post](https://github.com/mindulle/Documents/blob/main/js/s/dynamic-getter-setter-proxy/README.md) is a great place to start.
